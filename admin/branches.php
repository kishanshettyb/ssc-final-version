...
<head>
  ...
  <title>Admin Dashboard - Branches</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#"><i class="fas fa-bars menu-icon shadow-lg"></i>Branches</a>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">Branches List Table</h3>
            </div>
            <div class="table-responsive">
              <table id="branchesTable" class="table align-items-center table-flush">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input name="branch_phone" maxlength="20" type="text" class="form-control" placeholder="Enter Branch phone">
                </div>
              </div>
               <div class="col-md-12">
                <div class="form-group">
  ...
  <script src="./assets/scripts/branches.js"></script>
</body>
