...
<head>
  ...
  <title>Admin Dashboard - Recevings List</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        ...
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#"><i
            class="fas fa-bars menu-icon shadow-lg"></i>Receivings List</a>
    ...
    <div class="container-fluid mt--7">
      <div class="row">
        <div class="col mb-4">
          <div class="card shadow hide">
            <div class="card-header border-0 hide">
              <form id="filterForm">
                <div class="row">
                  <div class="col-md-3">
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">Receiving Details</h3>
            </div>
  ...
  <script src="./assets/scripts/receivings-list.js"></script>
  <script>
