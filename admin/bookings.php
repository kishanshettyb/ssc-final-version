...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        ...
        <h4 class="branch-text" data-branch-name="<?php echo $_SESSION["session_branch"] ?>" data-branch-id="<?php echo $_SESSION["session_branch_id"] ?>">Branch : <?php echo $_SESSION["session_branch"] ?></h4>
        <!-- User -->
  ...
  <script src="./assets/scripts/bookings.js"></script>
