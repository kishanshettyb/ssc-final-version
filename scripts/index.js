...
// 			$.ajax({
// 				url: "api/bookings/bookings_count.php?admin_id=" + admin_id,
// 				type: "GET",
// 				dataType: "json",
...
// 					$(".gc_no").text("BLR00" + count);
// 					$("#gc_no").val("BLR00" + count);
// 				},
// 				async: false,
// 			});
// 		} else {
...
// 					$("#branches").append(
// 						$("<option>")
// 							.text(v.branch_name + "  " + v.branch_code)
...
// 	if (keyword != "") {
// 		$.ajax({
// 			url: "api/bookings/search.php?s=" + keyword,
// 			type: "GET",
// 			dataType: "json",
// 			contentType: "application/json; charset=utf-8",
// 			error: function (xhr, status, error) {
// 				var err = eval("(" + xhr.responseText + ")");
// 				if (err.message == "No consignor_name_add found.") {
...
// 						$("<option>")
// 							.text(v.consignor_name_add)
// 							.attr("value", v.consignor_name_add)
// 					);
// 				});
// 			},
// 		});
...
// 	if (keyword != "") {
// 		$.ajax({
// 			url: "api/bookings/search_consignee.php?s=" + keyword,
// 			type: "GET",
// 			dataType: "json",
// 			contentType: "application/json; charset=utf-8",
// 			error: function (xhr, status, error) {
// 				var err = eval("(" + xhr.responseText + ")");
// 				if (err.message == "No consignee_name_add found.") {
...
// 						$("<option>")
// 							.text(v.consignee_name_add)
// 							.attr("value", v.consignee_name_add)
// 					);
// 				});
// 			},
// 		});
